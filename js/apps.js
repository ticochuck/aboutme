...
//This vae keeps count of correct answers
...
for (var i = 0; i < 3; i++) {
  ...
  if ((question2.toLowerCase() === 'yes') || (question2.toLowerCase() === 'y')) {
    ...
    alert('That is not a valid answer. Please enter "yes" or "no".');  
      ...
      alert('That is not a valid answer. The correct answer is "yes", Chuck is Chinese-Costa Rica.');
     }
  }
}
questTwo();
...
for (var i = 0; i < 3; i++) {
  ...
  if ((question3.toLowerCase() === 'yes') || (question3.toLowerCase() === 'y')) {
    ...
    alert('That is not a valid answer. Please enter "yes" or "no".');  
      ...
      alert('That is not a valid answer. The correct answer is "yes", Chuck loves burgers.');
    }
  }
}
questThree();
...
function questFour() {
  ...
  if ((question4.toLowerCase() === 'no') || (question4.toLowerCase() === 'n')) {
    ...
    alert('That is not a valid answer. Please enter "yes" or "no".');  
      ...
      alert('That is not a valid answer. The correct answer is "no", Chuck has 3 kids under 6 years old.');
    }
  }
}
questFour();
...
function questFive() {
  ...
  if ((question5.toLowerCase() === 'yes') || (question5.toLowerCase() === 'y')) {
    ...
    alert('That is not a valid answer. Please enter "yes" or "no".');  
      ...
      alert('That is not a valid answer. The correct answer is "yes", Chuck is married to Laura.');
    }
  }
}
questFive();
...
for (var i = 1; i < 5; i++) {
var question6String = prompt('How old is my grandma?');
//convert the string value into an integer
var question6 = parseInt(question6String, 10);
